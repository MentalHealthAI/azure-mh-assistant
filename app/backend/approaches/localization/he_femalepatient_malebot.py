...
heFemalePatientMaleBot = {
    ...
    "startExercise1Danger": lambda request_context: start_exercise_1_danger(request_context, is_patient_male=False, is_bot_male=True),
    "startExercise2Accountability": lambda request_context: start_exercise_2_accountability(request_context, is_patient_male=False, is_bot_male=True),
    "startExercise3Self": lambda request_context: start_exercise_3_self(request_context, is_patient_male=False, is_bot_male=True),
    "startExercise4Future": lambda request_context: start_exercise_4_future(request_context, is_patient_male=False, is_bot_male=True),
    "startExercise5Others": lambda request_context: start_exercise_5_others(request_context, is_patient_male=False, is_bot_male=True),
    "howMuchDistressAndAdvanceVideo": lambda request_context: how_much_distress_and_advance_video(request_context, is_patient_male=False, is_bot_male=True),
